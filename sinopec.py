...
def case31(data):				#加油机发送实时信息命令
	...
	if count == '00':			#信息数量 = 1
		operate ='命令字: ' + data_list[7] + '（加油机发送实时信息，无法插入）\n'
		return operate
	if count == '01':			#信息数量 = 1
		if data_id == '01':		#卡插入
...
def ttc_excle():
	header = ['Nozzle', 'POS-TTC', 'PC-Time', 'Oil-Time', 'Card', 'T-Type', 'Balance', 'Liter', 'Unit', 'Amount', 'Total', 'G-Code']
